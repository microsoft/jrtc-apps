...
uint64_t jbpf_main(void* state)
{
    ...
    // get the output map
    int zero_index=0;
    cucp_pdu_session_remove *out = (cucp_pdu_session_remove *)jbpf_map_lookup_elem(&output_tmp_map, &zero_index);
    if (!out) {
